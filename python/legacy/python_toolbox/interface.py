...
from programs import leere_seite, fensteradresse, sortieren_nach_dateiname, fensteradressev2, f_numb_checker, absatz_korrigieren


ui_support = ["fensteradresse", "leere_seite", "sortiere_nach_dateiname", "fensteradressev2", "absatz_korrigieren", "sortieren_nach_dateiname", "absatz_korrigieren"]
...
help_text_dic = {
    ...
    "absatz_korrigieren"       : absatz_korrigieren.help_text
}
...
exp_date     = "2026-09-01" # gut das hätte 
